...
module.exports = class extends think.Service {
    ...
    parseExpressResult(requestResult) {
        ...
        if (
            !think.isEmpty(requestResult.Traces) &&
            Array.isArray(requestResult.Traces)
        ) {
    ...
    generateDataSign(requestData) {
        return encodeURI(
            Buffer.from(think.md5(requestData + think.config("express.appkey")))
        ).toString("base64");
    }
};
